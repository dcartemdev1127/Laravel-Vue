  ...
  <v-card>
    <v-card-text>
      <v-row>
        <v-col cols="12" lg="4">
          ...
          <v-text-field
            ...
            :class="{
              'is-invalid': v$.formFields.fname.$errors.length,
            }"
          />
          <div
        ...
        <v-col cols="12" lg="4">
          ...
          <v-text-field
            ...
            :class="{
              'is-invalid': v$.formFields.lname.$errors.length,
            }"
          />
          <div
        ...
        <v-col cols="12" lg="4">
          ...
          <v-text-field
            ...
            :class="{
              'is-invalid': v$.formFields.username.$errors.length,
            }"
          />
          <div
        ...
        <v-col cols="12" lg="4">
          ...
          <v-text-field
            ...
            placeholder="City"
            :class="{
              'is-invalid': v$.formFields.city.$errors.length,
            }"
          />
          <div
        ...
        <v-col cols="12" lg="4">
          ...
          <v-select
            ...
            hide-details
            :class="{
              'is-invalid': v$.formFields.state.$errors.length,
            }"
          />
          <div
        ...
        <v-col cols="12" lg="4">
          ...
          <v-text-field
            ...
            placeholder="Zip"
            :class="{
              'is-invalid': v$.formFields.zip.$errors.length,
            }"
          />
          <div
      ...
      <v-checkbox
        ...
        hide-details
        :class="{
          'is-invalid': v$.formFields.isAgree.$errors.length,
        }"
      >
        <template #label>
