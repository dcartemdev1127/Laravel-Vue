...
import DashBoard from "@/components/learning/instructors/listView/DashBoard.vue";
import TopFilters from "@/components/learning/instructors/listView/TopFilters.vue";
import Listing from "@/components/learning/instructors/listView/Listing.vue";
import { instructorsList } from "@/components/learning/instructors/listView/utils";
...
const query = ref("");
const filteredData = ref<InstructorDataType[]>(instructorsList.reverse());
...
<template>
  <DashBoard />
  <Card title="Instructors List" class="mt-4">
