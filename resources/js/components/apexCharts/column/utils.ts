...
export const getCharts = (getChartColorsArray: Function) => {
  ...
  const colors = getChartColorsArray(
    '["--tb-primary", "--tb-success", "--tb-warning", "--tb-danger", "--tb-body-color", "--vz-info"]'
  );
    ...
    chartOptions: {
      ...
      plotOptions: {
        bar: {
          isDumbbell: true,
          columnWidth: 3,
          dumbbellColors: getChartColorsArray(
            '["--tb-success", "--tb-primary"]'
          ),
        },
      },
      legend: {
  ...
  const columnNegativeChart = {
    ...
    chartOptions: {
      colors: getChartColorsArray(
        '["--tb-success", "--tb-primary", "--tb-warning"]'
      ),
      chart: {
        type: "bar",
        height: 350,
