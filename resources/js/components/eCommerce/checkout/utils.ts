...
import {
  AddressType,
  ShippingMethodType,
} from "@/components/eCommerce/checkout/types";
...
export const country: MenuSelectItemType[] = [
...
export const shippingMethod: ShippingMethodType[] = [
  {
    title: "Free Delivery",
    subtitle: "Expected Delivery 3 to 5 Days",
    price: "Free",
    value: "free",
    icon: "ph-truck ph-lg",
  },
  {
    ...
    subtitle: "Delivery within 24hrs.",
    price: "$24.99",
    value: "express",
    icon: "ph-airplane ph-lg",
  },
];
...
export const addressType: MenuSelectItemType[] = [
  { value: "home", label: "Home (7am to 10pm)" },
  { value: "office", label: "Office (11am to 7pm)" },
];
